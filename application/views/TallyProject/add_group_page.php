...
<div class="" style="padding:8px;background-color:#ffffff;">
    <form class="form-horizontal" id="add_grp_form" method="post" action="">
        <div class="form-group">
            <div class="col-sm-12">
                ...
                <div class="col-sm-8 m-auto">
                    ...
                    <select id='company_namegrp' class="form-control" name='company_namegrp' onchange="get_ledger_list()"></select>
                </div>
        ...
        <div class="form-group w-100">
            <div class="col-sm-6 col-sm-offset-4 m-auto text-center">
                <button type="button" onclick="insert_group()" class="btn btn-primary mt-3">Insert</button>
            </div>
        </div>
    </form>
